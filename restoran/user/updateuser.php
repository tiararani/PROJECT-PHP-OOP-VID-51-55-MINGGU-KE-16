...
<div class="form-group">
    ...
    <div class="form-group" w-50>
                ...
                <input type="password" name="password" required required value="<?php echo $row['password']?>" class="form-control mt-2">

    </div>

    <div class="form-group" w-50>
                <label for="">Konfirmasi Password</label>
                <input type="password" name="konfirmasi" required required value="<?php echo $row['password']?>" class="form-control mt-2">
