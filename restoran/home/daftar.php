...
<div class="form-group">
    ...
    <form action="" method="post">
            <div class="form-group" w-50>
                ...
                <input type="text" name="pelanggan" required placeholder="isi pelanggan" class="form-control mt-2">

    </div>

    <div class="form-group" w-50>
                <label for="">Alamat</label>
                <input type="text" name="alamat" required placeholder="isi alamat" class="form-control mt-2">

    </div>

    <div class="form-group" w-50>
                <label for="">Telp</label>
                <input type="text" name="telp" required placeholder="isi telp" class="form-control mt-2">
